...
class M_order extends CI_Model {
    ...
    function getRecentOrderData($customer_id) {
        ...
        $this->db->select('o.id,o.order_id,o.invoice_id,o.customer_id,o.seller_id,o.product_id,o.product_name,o.image_thumb,o.brand,o.style_code,o.sku,o.selling_price,o.payment_price,o.weight,o.shipping_time,o.colour,o.size,o.qty,o.order_date,o.delivery_date,o.order_status,o.pay_method,o.request,s.business_name');
    ...
    function cancelOrder() {
        ...
        $this->db->update('order_mst', $request, array('order_id' => $order_id));
        return True;
    }
    ...
    function returnOrder() {
        ...
        $request = array(
            'request' => ($activity == 0) ? '2' : '3',
            'return_date' => date('Y-m-d H:i:s'),
            'return_reason' => $this->input->post('cancel_reason')
        );

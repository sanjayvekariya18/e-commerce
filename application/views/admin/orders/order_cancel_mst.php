...
<section role="main" class="content-body">
        ...
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/order_cancel/search">
                        <div class="row">
                            <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                <header class="panel-heading">                  
                    <h2 class="panel-title">Cancel Order History</h2>                    
                </header>
                <div class="panel-body">

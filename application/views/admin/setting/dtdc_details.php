    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right" style="padding-right: 10px;">
            <ol class="breadcrumbs">
                ...
                <li><span>DTDC Details Master</span></li>
            </ol>           
        </div>
    </header>
        ...
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                <header class="panel-heading">
                    <h2 class="panel-title">DTDC Tracking Id Detail</h2>
                </header>
                <div class="panel-body">
                    <form id="dtdcdetailform" class="form-horizontal" method="POST" action="#">
    ...
    $(document).ready(function() {
        ...
        $('#saveBtn').on("click", function() {
            ...
            if ($flag == 1) {
                ...
                if ($btntype == "save")
                {
                    $url = "<?= site_url() ?>admin/dtdc_details/addTrackingData";
                    $('#dtdcdetailform').attr('action', $url);
                    $('#dtdcdetailform').submit();
                }
                else if ($btntype == "update")
                {
                    $url = "<?= site_url() ?>admin/dtdc_details/updateTrackingData";
                    $('#dtdcdetailform').attr('action', $url);
                    $('#dtdcdetailform').submit();
                }
            }
        ...
        $('.delete').on("click", function() {
            ...
            alertify.confirm("Are You Sure To Delete This Tracking Id Details ...!!", function(e) {
                if (e) {
                    window.location.href = "<?= site_url() ?>admin/dtdc_details/deleteTrackingData?id=" + $id;
                    return true;
                }
                else {
                    return false;

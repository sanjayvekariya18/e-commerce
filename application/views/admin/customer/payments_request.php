    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right" style="padding-right: 10px;">
            <ol class="breadcrumbs">
                ...
                <li><span>Refund Payment</span></li>
            </ol>           
        </div>
    </header>
        ...
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                <header class="panel-heading">
                    <h2 class="panel-title">Refund Payment</h2>
                </header>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6">
                            <form id="paymentform" class="form-horizontal" method="POST" action="<?= site_url() ?>admin/refund_request/payment">   
                                <input type="hidden" name="request_id" value="<?= isset($request->id) ? base64_encode($request->id) : '' ?>"/>
                                <input type="hidden" name="order_id" value="<?= isset($request->order_id) ? base64_encode($request->order_id) : '' ?>"/>
                                <input type="hidden" name="customer_id" value="<?= isset($request->customer_id) ? base64_encode($request->customer_id) : '' ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="customer_name" name="customer_name" type="text" class="form-control" value="<?= isset($request->first_name) ? $request->first_name." ".$request->last_name : '' ?>">
                                    </div>
                                </div>                        
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="amount_paid" name="amount_paid" type="text" class="form-control" value="<?= isset($request->amount) ? $request->amount : '' ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <form class="form-horizontal" method="POST" action="#">                        
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label class="control-label" style="text-align: left;"><?= isset($request->ifsc) ? $request->ifsc : '' ?> </label>
                                    </div>
                                </div>
                                <div class="form-group">

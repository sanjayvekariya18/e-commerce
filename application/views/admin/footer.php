...
<script type="text/javascript">
    $(document).ready(function() {        
        $('#bellnewseller').click(function() {
            $.ajax({
                url: "<?= site_url()?>admin/seller/resetNewSellerNotify",
                type: "post",
        ...
        $('#bellnewpayout').click(function() {
            $.ajax({
                url: "<?= site_url()?>admin/payments_request/resetNewPayoutNotify",
                type: "post",
                success: function(data, textStatus, jqXHR) {
        ...
        $('#bellnewrefund').click(function() {
            $.ajax({
                url: "<?= site_url()?>admin/refund_request/resetNewRefundNotify",
                type: "post",
                success: function(data, textStatus, jqXHR) {

<section role="main" class="content-body">
        ...
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/payments_request/payoutRequestSearch">
                        <div class="row">
                            <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                <header class="panel-heading">                  
                    <h2 class="panel-title">Payout Request Detail</h2>                    
                </header>
                <div class="panel-body">       
                    ...
                    <form id="actionform" name="actionform" method="POST" action="<?= site_url() ?>admin/payments_request/payoutStatusUpdate">
                                ...
                                if (isset($request) && is_array($request)) {
                                    foreach ($request as $val) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($val->status == 0) { ?>
                                                    <a href="<?= site_url() ?>admin/payments_request/requestPaid?id=<?= base64_encode($val->request_id) ?>"  class="btn btn-success btn-xs" ><i class="fa fa-check-square-o"></i></a>
                                                    <?php } ?>
                                            </td>
                                        </tr>
                                        <?php

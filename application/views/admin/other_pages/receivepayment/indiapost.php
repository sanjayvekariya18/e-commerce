<section role="main" class="content-body">
    <header class="page-header">
        <h2>Indiapost Payment Master</h2>
                                ...
                                if (isset($payments)) {
                                    foreach ($payments as $payment) {
                                        ...
                                        <tr>                                            
                                            ...
                                            <td><a href="<?= site_url() ?>admin/others/indiapostPaymentDelete?id=<?= base64_encode($payment->id) ?>" class="btn btn-danger btn-xs" >Delete</a></td>
                                        </tr>
                                        <?php
                                    }
                                }

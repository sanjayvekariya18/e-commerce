        ...
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body" style="display:none"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/others/allDelivered">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                if (isset($orders)) {
                                    ...
                                    foreach ($orders as $order) {
                                        ...
                                        <tr>
                                            ...
                                            <td><i class="fa fa-rupee"></i> <?= $payment ?></td>

...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>All Indiapost Orders Master</h2>
        ...
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body" style="display:none"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/others/allIndiaPost">
                        <div class="row">
                            <div class="col-md-4">
...
<?php endif; ?>
        ...
        $("#paymentconfirm").click(function() {
            ...
            $('#tableform').attr('action', '<?= site_url() ?>admin/others/indiapostReceivePayment');
            $('#tableform').submit();
        });
        ...
        $("#expenseconfirm").click(function() {
            ...
            $('#tableform').attr('action', '<?= site_url() ?>admin/others/indiapostPayExpense');
            $('#tableform').submit();
        });
    });
</script>
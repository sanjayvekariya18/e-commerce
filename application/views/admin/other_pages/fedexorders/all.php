        ...
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body" style="display:none"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/others/allFedex">
                        <div class="row">
                            <div class="col-md-4">
...
<?php endif; ?>
        ...
        $("#paymentconfirm").click(function () {
            ...
            $('#tableform').attr('action', '<?= site_url() ?>admin/others/fedexReceivePayment');
            $('#tableform').submit();
        });
        ...
        $("#expenseconfirm").click(function () {
            ...
            $('#tableform').attr('action', '<?= site_url() ?>admin/others/fedexPayExpense');
            $('#tableform').submit();
        });
    });
</script>
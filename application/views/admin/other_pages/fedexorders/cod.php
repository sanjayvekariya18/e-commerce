        ...
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body" style="display:none"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/others/fedexCod">
                        <div class="row">
                            <div class="col-md-4">
                                    ...
                                    foreach ($orders as $order) {
                                        ...
                                        <tr>
                                            ...
                                            <td><i class="fa fa-rupee"></i> <?php
                                                ...
                                                ?></td>
                                            <td><i class="fa fa-rupee"></i> <?= $order->shipping_charge + $order->cod_charge + ($order->cod_charge * 14.5 / 100 ) ?></td>
                                            <td>
                                                <?php
                                            ...
                                            <td><i class="fa fa-rupee"></i> <?php
                                                if ($order->order_status == "4" || $order->order_status == "5" || $order->order_status == "7" || $order->order_status == "9") {

        ...
        <div class="col-md-12">
            <section class="panel">
                ...
                <div class="panel-body"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/product_rejected/search">
...
<script type="text/javascript">
    $(function() {
        ...
        $('.view').click(function() {
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    $('#approve_status').val($product['approve_status']);
        ...
        $('#viewconfirm').click(function() {
            $.ajax({
                url: '<?= site_url() ?>admin/product/modelViewProductReject',
                type: 'post',

<section role="main" class="content-body">
    <header class="page-header">
        <h2>Product Approved Management</h2>
        ...
        <div class="col-md-12">
            <section class="panel">
                ...
                <div class="panel-body"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/product_approved/search">
        ...
        <div class="col-md-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Approved Details</h2>
                </header>
                <div class="panel-body">
...
<script type="text/javascript">
    $(function() {
        ...
        $('#viewconfirm').click(function() {
            $.ajax({
                url: '<?= site_url() ?>admin/product/modelViewProductApprove',
                type: 'post',

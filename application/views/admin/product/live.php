        ...
        <div class="col-md-12">
            <section class="panel">
                ...
                <div class="panel-body"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/product_live/search">
        ...
        <div class="col-md-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Live Product Details</h2>
                </header>
                <div class="panel-body">
...
<script type="text/javascript">
    $(function() {
        ...
        $('#viewconfirm').click(function() {
            $.ajax({
                url: '<?= site_url() ?>admin/product/modelViewProductLive',
                type: 'post',

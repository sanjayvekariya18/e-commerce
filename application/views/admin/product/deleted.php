<section role="main" class="content-body">
    <header class="page-header">
        <h2>Product Deleted Request Management</h2>
        ...
        <div class="col-md-12">
            <section class="panel">
                ...
                <div class="panel-body"> 
                    <form name="search" method="POST" action="<?= site_url() ?>admin/product_deleted/search">
        ...
        <div class="col-md-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Deleted Request Details</h2>
                </header>
                <div class="panel-body">
                            ...
                            <tbody>
                                ...
                                if (isset($products)) {
                                    foreach ($products as $val) {
                                        ...
                                        <tr>
                                            <td style="text-align: center"><input name="allProduct[]" value="<?= $val->product_id ?>" type="checkbox" ></td>
                                            <td>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#viewconfirm').click(function() {
            $.ajax({
                url: '<?= site_url() ?>admin/product/modelViewProductDeleted',
                type: 'post',
        ...
        $('#delete').click(function() {
            $.ajax({
                url: '<?= site_url() ?>admin/product/deleteProductPermenent',
                type: 'post',
                ...
                success: function(data, textStatus, jqXHR) {
                    if (data)
                    {
                        ...
                        alertify.error("Product Information Not Updated");
                    }
                    location.reload(true);
                }
            });

            ...
            <div class="col-md-12">
                <section class="panel">
                    ...
                    <div class="panel-body" style="display:none"> 
                        <form name="search" method="POST" action="<?= site_url() ?>seller/mylisting/search">
        ...
        <div class="col-md-12">
            <div class="tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#nonlive" data-toggle="tab">Non Live</a>
                    </li>
                    <li>
                        <a href="#stockout" data-toggle="tab">Stock Out</a>
                    </li>
                </ul>
                <div class="tab-content">                    
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-striped mb-none" id="datatable-default1">
                                    ...
                                    <tbody>
                                        <?php
                                        if (isset($liveproducts)) {
                                            foreach ($liveproducts as $val) {
                                                ?>
                                                <tr>
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-striped mb-none" id="datatable-default2">
                                    ...
                                    <tbody>
                                        <?php
                                        if (isset($nonliveproducts)) {
                                            foreach ($nonliveproducts as $val) {
                                                ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table>                                                            
                                                            <tr>
                                                                <td style="text-align: right"><a class="mb-xs mt-xs mr-xs modal-with-move-anim btn btn-default edit" href="#modalEdit" id="<?= $val->product_id ?>">Start Selling</a></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="text-align: right;"><a class="mb-xs mt-xs mr-xs btn btn-default" href="<?= site_url() ?>seller/product/view?pid=<?= base64_encode($val->product_id) ?>"target="_blank" style="width: 102px;">Preview</a></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                    ...
                    <div id="stockout" class="tab-pane">
                        <section class="panel">
                            <header class="panel-heading">
                                <div class="panel-actions">
                                    <a href="#" class="fa fa-caret-down"></a>                                    
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-striped mb-none" id="datatable-default3">
                                    <thead>
                                        <tr>
                                            <th>Product details</th>
                                    ...
                                    <tbody>
                                        <?php
                                        if (isset($stockoutproducts)) {
                                            foreach ($stockoutproducts as $val) {
                                                ?>
                                                <tr>
                                                    <td>
                                                        <img src="<?= $val->image_medium ?>" width="100" height="100" style="border:1px;float: left;margin-right: 25px;"/>
        ...
        <form id="modelEditProduct" method="POST" action="#">
            <section class="panel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <select name="live_status" class="form-control">
                                        ...
                                        <option id="optActive" value="1">Active</option>
                                    </select>
                                </div>                                               
                            </div>
                        </div>
                ...
                <footer class="panel-footer">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button id="editconfirm" type="button" class="btn btn-primary ">Confirm</button>
                            <button class="btn btn-default modal-dismiss">Cancel</button>
                        </div>
                    </div>
                </footer>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#datatable-default1').dataTable({
            order: [],
            aLengthMenu: [[10, 15, 20, 25, 100, -1], [10, 15, 20, 25, 100, 'All']],
            aoColumnDefs: [{
                    bSortable: false,
                    aTargets: [0, 1, 2, 3]
                }],
        ...
        $('#datatable-default2').dataTable({order: [],
            aLengthMenu: [[10, 15, 20, 25, 100, -1], [10, 15, 20, 25, 100, 'All']],
            aoColumnDefs: [{
                    bSortable: false,
                    aTargets: [0, 1, 2]
        ...
        function editconfirm() {
            $('#editconfirm').click(function () {
                if ($('#Emodel_selling_price').val() != "") {
                    $.ajax({
                        url: '<?= site_url() ?>seller/product/startSellingProduct',
                        type: 'post',

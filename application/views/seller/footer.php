...
<!-- Vendor -->
<!--Export Table-->
<script src="<?= base_url() ?>assets/javascripts/exportjquery.min.js"></script>
<script src="<?= base_url() ?>assets/javascripts/jquery.battatech.excelexport.js"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#bellneworder').click(function() {
            $.ajax({
                url: "<?= site_url()?>seller/order/resetNewOrderNotify",
                type: "post",
        ...
        $('#bellcancelorder').click(function() {
            $.ajax({
                url: "<?= site_url()?>seller/order/resetCancelOrderNotify",
                type: "post",
                success: function(data, textStatus, jqXHR) {
        ...
        $('#bellreturnorder').click(function() {
            $.ajax({
                url: "<?= site_url()?>seller/order/resetReturnOrderNotify",
                type: "post",
                success: function(data, textStatus, jqXHR) {
        ...
        $('#bellreplaceorder').click(function() {
            $.ajax({
                url: "<?= site_url()?>seller/order/resetReplaceOrderNotify",
                type: "post",
                success: function(data, textStatus, jqXHR) {
        ...
        $('#bellnewpayout').click(function() {
            $.ajax({
                url: "<?= site_url()?>seller/payments/resetNewPayoutNotify",
                type: "post",
                success: function(data, textStatus, jqXHR) {

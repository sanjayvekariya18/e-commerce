                        ...
                        <div class="tab-content">
                            ...
                            <div id="todispatch" class="tab-pane">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <form id="dispatchform" action="" target="_blank" method="post">
...
<?php endif; ?>
        ...
        $('#dtdcsheet').click(function () {
            $('#dispatchform').attr('action',"<?=  site_url()?>seller/order/dtdcsheet");
            $('#dispatchform').submit();            
        });
        
        $('#indiapostsheet').click(function () {
            $('#dispatchform').attr('action',"<?=  site_url()?>seller/order/indiapostsheet");
            $('#dispatchform').submit();            
        });
    });
</script>

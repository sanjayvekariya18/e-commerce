                            ...
                            <table class="table table-striped mb-none" id="datatable-default1" style="width:100%">
                                <thead>
                                    <tr>                                       
                                        ...
                                        <th class="th5">Cancelled on</th>
                                        <th class="th6">Buyer details</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    if (isset($cancel) && is_array($cancel)) {
                                        foreach ($cancel as $val) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="text-dark" style="font-weight: bold"><?= date('M d, Y', strtotime($val->cancel_date)); ?></label>
                                                </td>
                                                <td>

        ...
        <div class="col-md-12">
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="<?= site_url() ?>seller/profile/updateDisplayInfo">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input name="brand_name" type="text" class="form-control" value="<?= $seller->brand_name ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="<?= site_url() ?>seller/profile/updatePickupInfo">
            ...
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body">
                    <form id="primaryinfoform" class="form-horizontal" method="post" action="<?= site_url() ?>seller/profile/updatePrimaryInfo">
            ...
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= site_url() ?>seller/profile/updateBusinessInfo">
                        <div class="form-group">
            ...
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="<?= site_url() ?>seller/profile/updateBankInfo">
                        <div class="form-group">
            ...
            <section class="panel panel-featured panel-featured-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= site_url() ?>seller/profile/updateDocumentInfo">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#pickup_pincode').focusout(function() {
            $pincode = $(this).val();
            $.ajax({
                url: '<?= site_url() ?>seller/profile/checkPincode',
                type: 'post',
...
switch ($msg) {
    case "RQ":
        $m = "Please Fill All Required Field Before Add Product ..!";
        $t = "error";
        break;
    default:
        $m = 0;

<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <span class="navigation_page">Leggings</span>
        </div>
        <!-- ./breadcrumb -->
        <!-- row -->
        <div class="row">
                ...
                <div class="block left-module">
                    ...
                    <div class="block_content">
                        ...
                        <div class="layered layered-filter-price">                            
                            ...
                            <!-- ./filter Rise -->
                            <?php if (isset($rise) && is_array($rise)) { ?> 
                                <div class="layered_subtitle">Rise</div>
                                <div class="layered-content filter-size">
                                    <ul class="check-box-list">
                                        <?php foreach ($rise as $val) { ?>
                                            <li style="width:100%">
                                                <input type="checkbox" id="rise<?= $val['variation_id'] ?>" name="variation[]" value="<?= $val['variation_id'] ?>" class="myfilter"
                                                <?php
                                                if ($this->input->get('id') != "") {
                                                    if ($this->input->get('id') == $val['variation_id']) {
                                                        echo "checked";
                                                ...
                                                ?>/>
                                                <label for="rise<?= $val['variation_id'] ?>">
                                                    <span class="button"></span><?= $val['variation_name'] ?>
                                                </label>   
                                            </li>
                                        <?php } ?>  
                            ...
                            <!-- ./filter Fit -->
                            <?php if (isset($fit) && is_array($fit)) { ?> 
                                <div class="layered_subtitle">Fit</div>
                                <div class="layered-content filter-size">
                                    <ul class="check-box-list">
                                        <?php foreach ($fit as $val) { ?>
                                            <li style="width:100%">
                                                <input type="checkbox" id="fit<?= $val['variation_id'] ?>" name="variation[]" value="<?= $val['variation_id'] ?>" class="myfilter"
                                                <?php
                                                if ($this->input->get('id') != "") {
                                                    if ($this->input->get('id') == $val['variation_id']) {
                                                        echo "checked";
                                                ...
                                                ?>/>
                                                <label for="fit<?= $val['variation_id'] ?>">
                                                    <span class="button"></span><?= $val['variation_name'] ?>
                                                </label>   
                                            </li>
                                        <?php } ?>  
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title">Leggings</span>
                    </h2>
    ...
    $(document).ready(function() {       
        ...
        $('.myfilter').click(function() {
            ...
            if ($exFlag)
            {
                ...
                $exFlag = 0;
                $.ajax({
                    url: "<?= site_url() ?>womens/leggingsFilter",
                    type: "post",
            ...
            if ($(window).scrollTop() + $(window).height() > $(document).height() - 300) {
                if ($exFlag)
                {
                    ...
                    if ($productEnd) {
                        ...
                        if ($isFilter == 0) {
                            $.ajax({
                                url: "<?= site_url() ?>womens/pingLeggings",
                                type: "post",
                                data: {'start': $start},
                                success: function(data, textStatus, jqXHR) {
                                    $exFlag = 1;
                            ...
                            $.ajax({
                                url: "<?= site_url() ?>womens/PingFilterLeggings",
                                type: "post",

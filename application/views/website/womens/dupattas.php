<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <span class="navigation_page">Dupattas</span>
        </div>
        <!-- ./breadcrumb -->
        <!-- row -->
        <div class="row">
                                ...
                                <div class="layered-content filter-size">
                                    <ul class="check-box-list">
                                        <?php foreach ($work as $val) { ?>
                                            <li style="width:100%">
                                                <input type="checkbox" id="pattern<?= $val['variation_id'] ?>" name="variation[]" value="<?= $val['variation_id'] ?>" class="myfilter"/>
                                                <label for="pattern<?= $val['variation_id'] ?>">
                                                    <span class="button"></span><?= $val['variation_name'] ?>
                                                </label>   
                                            </li>
                                        <?php } ?>  
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title">Womens Dupattas</span>
                    </h2>
    ...
    $(document).ready(function() {       
        ...
        $('.myfilter').click(function() {
            ...
            {                
                ...
                $exFlag = 0;
                $.ajax({
                    url: "<?= site_url() ?>womens/dupattasFilter",
                    type: "post",
            ...
            if ($(window).scrollTop() + $(window).height() > $(document).height() - 300) {
                if ($exFlag)
                {
                    ...
                    if ($productEnd) {
                        ...
                        if ($isFilter == 0) {
                            $.ajax({
                                url: "<?= site_url() ?>womens/pingDupattas",
                                type: "post",
                                data: {'start': $start},
                                success: function(data, textStatus, jqXHR) {
                                    $exFlag = 1;
                            ...
                            $.ajax({
                                url: "<?= site_url() ?>womens/PingFilterDupattas",
                                type: "post",

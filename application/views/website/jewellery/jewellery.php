<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <span class="navigation_page">Jewellery</span>
        </div>
        <!-- ./breadcrumb -->
        <!-- row -->
        <div class="row">
                ...
                <div class="block left-module">
                    ...
                    <div class="block_content">
                        ...
                        <div class="layered layered-filter-price">                            
                            ...
                            <!-- ./filter Gender -->
                            <?php if (isset($gender) && is_array($gender)) { ?> 
                                <div class="layered_subtitle">Gender</div>
                                <div class="layered-content filter-size">
                                    <ul class="check-box-list">
                                        <?php foreach ($gender as $val) { ?>
                                            <li style="width:100%">
                                                <input type="checkbox" id="gender<?= $val['variation_id'] ?>" name="variation[]" value="<?= $val['variation_id'] ?>" class="myfilter"
                                                <?php
                                                ...
                                                ?>/>
                                                <label for="gender<?= $val['variation_id'] ?>">
                                ...
                                <div class="layered-content filter-size">
                                    <ul class="check-box-list">
                                        <?php foreach ($material as $val) { ?>
                                            <li style="width:100%">
                                                <input type="checkbox" id="material<?= $val['variation_id'] ?>" name="variation[]" value="<?= $val['variation_id'] ?>" class="myfilter"/>
                                                <label for="material<?= $val['variation_id'] ?>">
                                                    <span class="button"></span><?= $val['variation_name'] ?>
                                                </label>   
                                            </li>
                                        <?php } ?>  
                            ...
                            <!-- ./filter Metals Type -->
                            <?php if (isset($metals_type) && is_array($metals_type)) { ?> 
                                <div class="layered_subtitle">Metals Type</div>
                                <div class="layered-content filter-size">
                                    <ul class="check-box-list">
                                        <?php foreach ($metals_type as $val) { ?>
                                            <li style="width:100%">
                                                <input type="checkbox" id="metals_type<?= $val['variation_id'] ?>" name="variation[]" value="<?= $val['variation_id'] ?>" class="myfilter"
                                                <?php
                                                if ($this->input->get('id') != "") {
                                                    if ($this->input->get('id') == $val['variation_id']) {
                                                        echo "checked";
                                                ...
                                                ?>/>
                                                <label for="metals_type<?= $val['variation_id'] ?>">
                                                    <span class="button"></span><?= $val['variation_name'] ?>
                                                </label>   
                                            </li>
                                        <?php } ?>  
                            ...
                            <!-- ./filter Metals Type -->
                            <!-- ./filter Style -->
                            <?php if (isset($style) && is_array($style)) { ?> 
                                <div class="layered_subtitle">Style</div>
                                <div class="layered-content filter-size">
                                    <ul class="check-box-list">
                                        <?php foreach ($style as $val) { ?>
                                            <li style="width:100%">
                                                <input type="checkbox" id="style<?= $val['variation_id'] ?>" name="variation[]" value="<?= $val['variation_id'] ?>" class="myfilter"
                                                <?php
                                                if ($this->input->get('id') != "") {
                                                    if ($this->input->get('id') == $val['variation_id']) {
                                                        echo "checked";
                                                ...
                                                ?>/>
                                                <label for="style<?= $val['variation_id'] ?>">
                                                    <span class="button"></span><?= $val['variation_name'] ?>
                                                </label>   
                                            </li>
                                        <?php } ?>  
                            ...
                            <!-- ./filter Style  -->
                            <!-- ./filter Gem Stone -->
                            <?php if (isset($gem_stone) && is_array($gem_stone)) { ?> 
                                <div class="layered_subtitle">Gem Stone</div>
                                <div class="layered-content filter-size">
                                    <ul class="check-box-list">
                                        <?php foreach ($gem_stone as $val) { ?>
                                            <li style="width:100%">
                                                <input type="checkbox" id="gem_stone<?= $val['variation_id'] ?>" name="variation[]" value="<?= $val['variation_id'] ?>" class="myfilter"
                                                <?php
                                                if ($this->input->get('id') != "") {
                                                    if ($this->input->get('id') == $val['variation_id']) {
                                                        echo "checked";
                                                ...
                                                ?>/>
                                                <label for="gem_stone<?= $val['variation_id'] ?>">
                                                    <span class="button"></span><?= $val['variation_name'] ?>
                                                </label>   
                                            </li>
                                        <?php } ?>  
                            ...
                            <!-- ./filter Gem Stone --> 
                            <!-- ./filter Shape -->
                            <?php if (isset($shape) && is_array($shape)) { ?> 
                                <div class="layered_subtitle">Shape</div>
                                <div class="layered-content filter-size">
                                    <ul class="check-box-list">
                                        <?php foreach ($shape as $val) { ?>
                                            <li style="width:100%">
                                                <input type="checkbox" id="shape<?= $val['variation_id'] ?>" name="variation[]" value="<?= $val['variation_id'] ?>" class="myfilter"
                                                <?php
                                                if ($this->input->get('id') != "") {
                                                    if ($this->input->get('id') == $val['variation_id']) {
                                                        echo "checked";
                                                ...
                                                ?>/>
                                                <label for="shape<?= $val['variation_id'] ?>">
                                                    <span class="button"></span><?= $val['variation_name'] ?>
                                                </label>   
                                            </li>
                                        <?php } ?>  
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title">Jewellery</span>
                    </h2>
    ...
    $(document).ready(function() {       
        ...
        $('.myfilter').click(function() {
            ...
            if ($exFlag)
            {
                ...
                $exFlag = 0;
                $.ajax({
                    url: "<?= site_url() ?>womens/jewelleryFilter",
                    type: "post",
            ...
            if ($(window).scrollTop() + $(window).height() > $(document).height() - 300) {
                if ($exFlag)
                {
                    ...
                    if ($productEnd) {
                        ...
                        if ($isFilter == 0) {
                            $.ajax({
                                url: "<?= site_url() ?>womens/pingJewellery",
                                type: "post",
                                data: {'start': $start},
                                success: function(data, textStatus, jqXHR) {
                                    $exFlag = 1;
                            ...
                            $.ajax({
                                url: "<?= site_url() ?>womens/PingFilterJewellery",
                                type: "post",
